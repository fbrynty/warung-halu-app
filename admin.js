...
// Templat untuk konfirmasi pesanan
...
// Templat untuk mengabarkan pesanan sedang diantar
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let itemsHtml = order.items.map(item => {
        // Menampilkan level pedas jika ada di data pesanan
    ...
    // Memanggil fungsi templat untuk membuat pesan
    ...
    if (status === 'pending') {
        // Jika status masih 'Pending', tampilkan "Tandai Selesai" dan "Batalkan Pesanan"
        actionButtonsHtml = `
        ...
        // Jika status sudah 'Selesai' (completed), hanya tampilkan "Hapus Pesanan"
        actionButtonsHtml = `
